...
public class SandwichShop {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("The sales goal for veggies sandwiches is " + goalForVeggies);
        ...
        int subsSold;
        System.out.println("The sales goal for veggies subs is " + goalForSubs);
        System.out.println("How many veggie sandwiches were sold today?");
        ...
        int soupSold;
        System.out.println("The sales goal for veggies sandwiches is " + goalForSoup);
        System.out.println("How many veggie sandwiches were sold today?");
